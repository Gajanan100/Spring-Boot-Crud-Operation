		...
		<form action="/updateEmp">
			<div class="user-box">
				<input type="text" name="emp_id" value="<%=emp.getEmp_id()%>"
					required=""> <label>Enter Employee Id</label>
			</div>
			<div class="user-box">
			...
			<div class="user-box">
				<input type="text" name="salary" value="<%=emp.getSalary()%>"
					required=""> <label> Enter Employee Salary</label>
			</div>
			<div class="user-box">
				<input type="text" name="position" value="<%=emp.getPosition()%>"
					required=""> <label>Enter Employee Position</label>


			</div>
			<div
				style="color: green; text-align: center; margin: 0 auto; background: #3A4450; padding: 5px;">
				<input
					style="background: #678CA4; font-size: 14px; padding: 3px; color: white;"
					type="submit"> <input
					style="background: #678CA4; font-size: 14px; padding: 3px; color: white;"
					type="reset">
